...
export class Message {
  constructor(protected readonly _options: Message.Options = {}) {}

  public async generatemessage(
    copilotId: string,
    chatId: string,
    request: SugarAiApi.MessageGenerateMessageRequest,
    requestOptions?: Message.RequestOptions,
  ): Promise<SugarAiApi.MessageGenerateMessageResponse> {
    const _response = await core.fetcher({
      ...
      body: await serializers.MessageGenerateMessageRequest.jsonOrThrow(
        request,
        {
    ...
    if (_response.ok) {
      return await serializers.MessageGenerateMessageResponse.parseOrThrow(
        _response.body,
        {
